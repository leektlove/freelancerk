...
public class SMSComponent {
    ...
    private static final String SOCKET_HOST = "211.172.232.124";
//    private static final Integer SOCKET_PORT = 7295;
//    private static final Integer SOCKET_PORT = 8200;
    private static final Integer SOCKET_PORT = 9201;
    private static final String TOKEN = "vmflfostj1";
    private static final String SERVICE_ID = "freelancer";
